<%-- 
    Document   : adminRecycledProducts
    Created on : Apr 3, 2016, 3:24:27 PM
    Author     : suhag
--%>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <ol class="breadcrumb">
                                <li class="active">
                                    <i class="fa fa-fw fa-table"></i> Recycled Products
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="panel panel-smart">
                                ...
                                <div class="panel-body">
                                    ...
                                    <form class="form-horizontal" role="form" action="/ToyStore/adminRecycledProducts" method="post">
                                        ...
                                        <div class="form-group">
                                            <label for="inputPOwner" class="col-sm-3 control-label">Product Owner:</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="inputPOwner" placeholder="Product Owner" name="owner" value="${owner}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-offset-3 col-sm-9">
                                                <button type="submit" class="btn btn-danger" value="/ToyStore/adminRecycledProducts">
                                                    Search
                                                </button>
                                            </div>
                                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><i class="fa fa-money fa-fw"></i> Recycled Product Search Result</h3>
                                </div>
                                <div class="panel-body">
                                                    ...
                                                    <tbody>
                                                        <c:forEach items="${products}" var="item">
                                                            <tr>
                                                                ...
                                                                <td>${item.price}</td>
                                                                <td>
                                                                    <a href="/ToyStore/adminViewRecycled?productId=${item.id}">
                                                                        <div>
