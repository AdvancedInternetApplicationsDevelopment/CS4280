<%-- 
    Document   : adminLogin
    Created on : Apr 3, 2016, 3:22:09 PM
    Author     : suhag
--%>
...
//                            $form.find('.alert').html('Thanks for signing up. Now you can sign in as ' + validator.getFieldElements('j_username').val()).show();
//                        });
            });
        </script>
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="panel panel-smart">
                                ...
                                <div class="panel-body">
                                    ...
                                    <!-- Login Form Starts -->
                                    <form class="form-inline" role="form" id="loginForm" novalidate="novalidate" action="j_security_check" method="post">
                                        <div class="form-group">
                                            <label class="sr-only" for="exampleInputEmail2">Username</label>
                                            <input type="text" class="form-control" id="exampleInputEmail2" placeholder="Username" name="j_username">
                                        </div>
                                        <div class="form-group">
                                            <label class="sr-only" for="exampleInputPassword2">Password</label>
                                            <input type="password" class="form-control" id="exampleInputPassword2" placeholder="Password" name="j_password">
                                        </div>
                                        <button type="submit" class="btn btn-danger disabled" disabled="disabled" value="submit">
                                            Login
                                        </button>
                                    </form>
                                    <!-- Login Form Ends -->
