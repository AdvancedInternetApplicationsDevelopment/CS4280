<%-- 
    ...
    Created on : Apr 3, 2016, 3:21:27 PM
    Author     : suhag
--%>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <ol class="breadcrumb">
                                <li class="active">
                                    <i class="fa fa-fw fa-table"></i> Products Catalogue -> Edit Product
                                </li>
                            </ol>
                        </div>
                    </div>
                            ...
                            <div class="panel panel-smart">
                                ...
                                <div class="panel-body">
                                    ...
                                    <form class="form-horizontal" role="form" action="/ToyStore/adminEditProducts" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="inputBrand" placeholder="Brand" name="brand" value="${brand}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputDescription" class="col-sm-3 control-label">Description:</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="inputDescription" placeholder="Description" name="description" value="${description}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputAvailability" class="col-sm-3 control-label">Quantity:</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="inputAvailability" placeholder="quantity" name="quantity" value="${quantity}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputPrice" class="col-sm-3 control-label">Price:</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="inputDescription" placeholder="Price" name="price" value="${price}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputAdditionalInfo" class="col-sm-3 control-label">Additional Information:</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="inputAdditionalInfo" placeholder="Additional Information" name="addInfo" value="${addInfo}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-3 col-sm-9">
                                                ...
                                                <button type="submit" class="btn btn-danger" value="/ToyStore/adminEditProducts">
                                                    Update
                                                </button>
                                            </div>
                                        </div>
                                ...
                                <c:if test="${error ==true}">
                                    <div class="alert alert-danger">
                                        <p> Error in update. Error message: ${errorMessage} </p>
                                    </div> 
                                </c:if>
